...
const DENY = [
  ...
  /ご注文|発送|配送|お届け|返品/,
  /* 「ログイン」単体を弾いていたため、「ログインすると500円もらえる」の
     ような “条件としてのログイン” まで落ちていた（2026-09-23 に発覚。
     東急線アプリのコイン付与が丸ごと消えていた）。
     落としたいのは認証そのものの通知なので、ログインは
     通知・確認・履歴といった語と並んだときだけ弾く。 */
  /パスワード|認証コード|ワンタイム|セキュリティ|本人確認/,
  /ログイン(?:通知|のお知らせ|履歴|できません|情報|ID)|新しい端末からのログイン|不正(?:な)?ログイン/,
  /様のアカウント|様へ|さまへ/,
  /退会|解約|契約更新|重要なお知らせ/,
];
