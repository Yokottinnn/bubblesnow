...
# ── ②' 学習 ──
# 昨日までの反応から好みを学び直す。材料は4つ。
#   タスク化した / 👍👎 を付けた / 詳細を開いた / 出したが無反応のまま7日
# 最後のひとつが「興味の無い話題」を落とす主役。出しても開かれない話題は
# ここで負の重みが付き、翌日以降スコアが下がって選ばれなくなる。
# 失敗しても選別は続ける（学習は「あれば効く」もので、無くても動く）。
echo ""
echo "--- ②' 過去の反応から学習 ---"
